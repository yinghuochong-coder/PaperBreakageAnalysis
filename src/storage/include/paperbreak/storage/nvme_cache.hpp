...
inline constexpr std::uint16_t nvme_format_version = 2U;
inline constexpr std::uint16_t nvme_legacy_format_version = 1U;
...
struct NvmeRollingCacheSnapshot final
{
    ...
    std::filesystem::path active_session_root;
